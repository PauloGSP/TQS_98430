...
public class API_Integration {
    ...
    @Test
     void whenValidInput_thenCreateCar() {
        ...
        assertThat(found).extracting(Car::getMaker).containsOnly("Corsa");
    }
    ...
    @Test
     void givenCars_whenGetCars_thenStatus200()  {
        ...
        assertThat(response.getBody()).extracting(Car::getMaker).containsExactly("Corsa", "Golf");
